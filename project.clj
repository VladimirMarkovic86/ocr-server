(defproject org.clojars.vladimirmarkovic86/ocr-server "0.2.1"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 [org.clojars.vladimirmarkovic86/server-lib "0.3.34"]
                 ...
                 [org.clojars.vladimirmarkovic86/ocr-lib "0.2.16"]
                 [org.clojars.vladimirmarkovic86/session-lib "0.2.27"]
                 [org.clojars.vladimirmarkovic86/common-server "0.3.44"]
                 [org.clojars.vladimirmarkovic86/ocr-middle "0.3.10"]
                 [org.clojars.vladimirmarkovic86/common-middle "0.2.10"]
                 [org.clojars.vladimirmarkovic86/audit-lib "0.1.35"]
